...
return res.status(200).json({message: "Registered for the  Event succsesfully"});
});
...
module.exports={createBooking,fetchAttendeeBooking,fetchEventBookings,cancelBooking};